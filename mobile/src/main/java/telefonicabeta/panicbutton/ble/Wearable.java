    ...
    */
    ...
    private final BluetoothGattCallback gattCallback = new BluetoothGattCallback() {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                for (BluetoothGattService gattService : gattServices) {
                    if (KIT_SERVICE.equals(gattService.getUuid().toString())) {
                        ...
                        BluetoothGattCharacteristic gattCharacteristic = gatt.getService(gattService.getUuid()).getCharacteristic(UUID.fromString(KIT_TX));
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                Log.i("BLE", characteristic.toString());
            }
        }
    };
